...
public class VanActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_CODE && resultCode == RESULT_OK)
        {
            ...
            Toast.makeText(VanActivity.this, "Image Successfully Taken", Toast.LENGTH_LONG).show();
        }
    }
*/
    ...
    public void MAKE_REQUEST(View view) {
        ...
        alertDelivery.setPositiveButton("PROCEED", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                {
                    Toast.makeText(VanActivity.this, "Please complete all fields", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    final ProgressDialog send = new ProgressDialog(VanActivity.this);
        ...
        alertDelivery.setNeutralButton("CANCEL", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(VanActivity.this, "Request Cancelled", Toast.LENGTH_LONG).show();
            }
        });
        alertDelivery.show();
    }
    ...
    public void FIND_AGENT(View view) {
        Intent open = new Intent(VanActivity.this, PlacePickerActivity.class);
        open.putExtra("DELIVERY_TYPE", "1");
        startActivity(open);
    }
    ...
    public void START_NEW_SESION(View view) {
        startActivity(new Intent(this, VanActivity.class));
        this.finish();
    }
        ...
        alertpayment.setPositiveButton("Continue", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (networkProvider.getText().toString().equals("1")) {
                    ...
                    {
                        if (ActivityCompat.checkSelfPermission(VanActivity.this,
    ...
    public void START_SPEAKING(View view) {
        textToSpeech.speak("Welcome, to our van delivery service! Please provide your delivery information in the available fields. \n" +
