...
public class MotorActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //INITIALLIZING TEXT-TO-SPEECH OBJECTS
...
//Declaring all the floating action buttons
    ...
    //TAKING THE USER BACK TO MAIN ACTIVITY WHEN THEY CLICK ON THE DFAULT BACK BUTTON
    @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_CODE && resultCode == RESULT_OK)
        {
            ...
            Toast.makeText(MotorActivity.this, "Image Successfully Taken", Toast.LENGTH_LONG).show();
        }
    }
*/
    ...
    public void MAKE_REQUEST(View view) {
        ...
        alertDelivery.setPositiveButton("PROCEED", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (prod_Name.isEmpty() || prod_desc.isEmpty() || category.equals("--select a category--") || sender.isEmpty() || receiver.isEmpty() || pickup.isEmpty() || dest.isEmpty()) {
                    Toast.makeText(MotorActivity.this, "Please complete all fields", Toast.LENGTH_SHORT).show();
                } else {
                    final ProgressDialog send = new ProgressDialog(MotorActivity.this);
        ...
        alertDelivery.setNeutralButton("CANCEL", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(MotorActivity.this, "Request Cancelled", Toast.LENGTH_LONG).show();
            }
        });
        alertDelivery.show();
    ...
    public void FIND_AGENT(View view) {
        Intent open = new Intent(MotorActivity.this, PlacePickerActivity.class);
        open.putExtra("DELIVERY_TYPE", "2");
        startActivity(open);
    }
        ...
        alertpayment.setPositiveButton("Continue", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (networkProvider.getText().toString().equals("1")) {
                    ...
                    {
                        if (ActivityCompat.checkSelfPermission(MotorActivity.this,
    ...
    public void START_SPEAKING(View view) {
        textToSpeech.speak("Welcome, to our motor delivery service! Please provide your delivery information in the available fields. \n" +
